...
const RegisterScreen = () => {
  ...
  return (
    <div className="h-screen w-screen flex flex-col justify-center" style={{
      ...
      <h1 className={`text-black font-bold text-5xl ml-7 mr-7 mb-10 register ${i18n.language}`} dir={i18n.language === 'ar' ? 'rtl' : 'ltr'}>
        {t('loginScreen.register')}
      </h1>
      <h3 className={`text-[#15406d] font-bold text-xl ml-7 mr-7 mb-10 registerh3 ${i18n.language}`} dir={i18n.language === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className={`flex items-center text-white registerSpan ${i18n.language}`}>
